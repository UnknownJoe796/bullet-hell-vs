...
class BradysGunLoadout : GunLoadout {
    ...
    override fun doButton(shipInterface: ShipInterface, button: Int) {
        ...
        when (button) {
            0 -> {
                shipInterface.shoot(Vector2(15f * reverseMod, sweetheartMod * 13f * reverseMod), Vector2(-10f * reverseMod, sweetheartMod * -8f * reverseMod), .5f)
                sweetheartMod *= -1
            }
            1 -> {
            ...
            5 -> {
                shipInterface.shoot(Vector2(25f * reverseMod, 0f), Vector2(-10f, 0f), .5f)
            }
