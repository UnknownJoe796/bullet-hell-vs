 ...
 */
class ZeldaPlayer : GameModel<GameController, GameView> {
    ...
    override fun generateController(dependency: GameController): Disposable = makeDisposable {
        ...
        val module = physics.body(this@ZeldaPlayer, null) {
            makeBody {
                type = BodyDef.BodyType.DynamicBody
                fixedRotation = true
                position.set(this@ZeldaPlayer.position)
                velocity.set(this@ZeldaPlayer.velocity)
